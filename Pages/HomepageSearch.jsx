      ...
      <main className="pt-32 pb-24 min-h-screen">
        ...
        <section className="max-w-screen-xl mx-auto px-8">
          <div className="flex items-baseline justify-between mb-12">
            ...
            <Link className="font-['Public_Sans'] text-sm text-primary hover:underline" to="/collections">
              Explore Collections
            </Link>
          </div>
        ...
        <section className="mt-32 max-w-screen-xl mx-auto px-8">
          <div className="bg-surface-container-low p-16 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <Link className="bg-primary text-on-primary font-['Public_Sans'] px-8 py-4 text-sm font-bold uppercase tracking-widest hover:opacity-90 transition-opacity inline-flex items-center justify-center" to="/submit">
                Upload Manuscript
              </Link>
            </div>
