...
const SubmitManuscript = () => {
  ...
  return (
    <div className="light min-h-screen flex flex-col bg-surface text-on-surface">
      ...
      <main className="flex-grow pt-32 pb-24 px-6 md:px-12 lg:px-16 max-w-screen-xl mx-auto w-full">
        {/* Hero Header */}
        <div className="mb-20 grid gap-12 xl:grid-cols-[1.2fr_0.3fr] items-start">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-extrabold tracking-tight text-slate-900 mb-4 font-['Public_Sans']">
              Upload Manuscript
            </h1>
            <p className="text-slate-600 font-['Newsreader'] text-xl leading-relaxed max-w-2xl">
              Contribute to the collective intelligence. Your research will be preserved in our high-fidelity archival system.
            </p>
          </div>
          <div className="hidden xl:flex justify-end">
            <div className="text-[10px] uppercase tracking-[0.5em] text-slate-400 leading-tight" style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}>
              SUBMISSION · MD - 2024
            </div>
          </div>
        </div>
