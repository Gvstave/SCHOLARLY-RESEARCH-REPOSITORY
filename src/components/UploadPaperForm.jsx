...
export default function UploadPaperForm() {
    ...
    return (
        <div className='bg-[#f4f4f4]'>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:rounded-xl">
                <div className="border-b border-gray-100 pb-5 mb-8 text-center md:text-left">
                    <h2 className="  text-primary">Submit a Paper</h2>
                    <p className="  mt-1.5">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="text-[1.5rem] leading-7.5 text-primary border-b border-border pb-2">4. Co-authors</div>
