  ...
  <div className="h-fit space-y-6">
   ...
   <form onSubmit={handleSave} className="space-y-4 ">
    ...
    <div className="flex items-start gap-2.5 pt-1 pb-2 text-left">
     ...
     />
     <label htmlFor="show-email-toggle" className=" text-primary-text   cursor-pointer select-none">
      <span className=" block text-primary ">Allow visibility on my papers</span>
