  ...
  return (
    <div className="bg-white border border-red-200 p-6 shadow-sm space-y-4">
      <div className="border-b border-red-100 pb-2 flex items-center justify-between">
        ...
        <span className="text-[9px] font-bold uppercase tracking-widest text-[#B45309] bg-amber-50 px-2 py-0.5 border border-amber-100">
          Cannot be undone
        </span>
      </div>

      <p className="text-[11.5px] leading-relaxed text-primary-text text-left">
      ...
      {showDeleteConfirm ? (
        <div className="bg-red-50/50 border border-red-200 p-3.5 space-y-3">
          <p className="text-[10px] font-bold text-red-800 uppercase tracking-widest text-left">
        ...
        <button
          ...
          className="w-full bg-red-50 hover:bg-red-100 border border-red-200 text-red-800 text-[10px] font-bold tracking-[0.12em] uppercase py-2.5 transition flex items-center justify-center gap-1.5 cursor-pointer"
        >
