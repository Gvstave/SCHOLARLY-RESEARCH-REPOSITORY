    ...
    <div className="bg-white border border-border p-6 md:p-8 shadow-sm grid grid-cols-1 lg:grid-cols-4 gap-8">
      <div className="lg:col-span-3 space-y-5 text-left">
        <div className="space-y-1">
          <span className="text-sm text-primary-text font-bold bg-gray-50 px-2.5 py-1 border border-border inline-block w-fit">
          ...
          <p className="text-sm font-semibold text-primary-text flex items-center gap-1">
        ...
        <div className="space-y-2 border-l-2 border-border pl-4">
          <h4 className="text-sm font-bold text-gray-500 tracking-widest flex items-center gap-1">
            <Layers className="w-3.5 h-3.5 text-gray-400" /> Abstract
          </h4>
          <p className="text-sm text-primary-text leading-relaxed text-justify">{paper.abstract}</p>
        </div>

        {paper.introduction && (
          <div className="space-y-1.5 text-sm text-primary-text text-left">
            <span className="font-bold text-sm tracking-widest text-gray-500">Introduction</span>
      ...
      <div className="flex flex-col justify-center gap-3 text-sm">
        ...
        <button
          ...
          className="bg-emerald-700 text-white py-3 font-bold tracking-widest hover:bg-emerald-800 transition flex items-center justify-center gap-1.5 disabled:bg-border cursor-pointer"
        >
        ...
        <button
          ...
          disabled={actioningId === paper.id}
          className="bg-gray-950 text-white py-3 font-bold tracking-widest hover:bg-primary transition flex items-center justify-center gap-1.5 disabled:bg-gray-300 cursor-pointer"
        >
