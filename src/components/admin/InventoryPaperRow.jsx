    ...
    <div className="p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-gray-50/50 transition">
      <div className="space-y-1 flex-1 min-w-0 text-left">
        <div className="flex items-center gap-2 flex-wrap">
          <span className="text-sm font-bold text-primary bg-gray-50 border border-border px-1.5 py-0.5">
            {paper.category}
          </span>
      ...
      <div className="flex items-center gap-3 shrink-0 self-stretch justify-end md:self-auto">
        <button
          ...
          className="border border-rose-200 hover:border-rose-600 bg-rose-50/30 text-rose-700 hover:bg-rose-700 hover:text-white px-3 py-1.5 text-sm font-bold tracking-widest transition cursor-pointer flex items-center gap-1.5 rounded-xs"
        >
