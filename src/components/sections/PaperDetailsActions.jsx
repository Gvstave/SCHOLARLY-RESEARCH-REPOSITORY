  ...
  return (
    <>
      {user && (
        <div className="bg-gray-50 border border-border p-5 space-y-4 text-left">
          <div className="flex items-center justify-between border-b border-border pb-2.5">
            <span className="text-sm font-bold text-primary tracking-widest flex items-center gap-1">
              <Quote className="w-3.5 h-3.5 text-gray-500" /> Cite this paper
            </span>
            {alreadyCited ? (
              <span className="text-sm font-bold text-green-600 bg-green-50 border border-green-200 px-2 py-1 rounded-sm">
                Cited &bull; Logged
              </span>
            ) : (
              <Button onClick={() => handleCite(selectedPaper)} variant="subtle" size="sm" className="text-sm px-2.5 py-1">
                Log Citation
              </Button>
            )}
          </div>
      ...
      <div className="border border-border p-5 space-y-4 bg-gray-50 text-left">
        <h4 className="text-sm font-bold tracking-widest text-primary">Full paper</h4>
        {user ? (
          <div className="space-y-3 bg-white border border-border p-3 text-left">
            <p className="text-sm text-gray-600 leading-relaxed">You can download the full manuscript.</p>
            <Button
              onClick={() => handleDownload(selectedPaper)}
              fullWidth
              variant="primary"
              className="text-sm py-3 shadow-sm"
          ...
          <div className="space-y-3.5">
            <div className="p-3 bg-white border border-[#E9E9F0] rounded-sm flex items-start gap-1.5 text-left">
              ...
              <div>
                <p className="text-sm font-bold text-primary-text ">Sign in to download</p>
                <p className="text-sm text-gray-500 leading-relaxed mt-1">Sign in to download the full manuscript of this paper.</p>
              </div>
            </div>
            <Button
              ...
              fullWidth
              variant="primary"
              className="text-sm tracking-[0.16em] py-3 shadow-sm"
