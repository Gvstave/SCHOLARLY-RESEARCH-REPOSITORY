...
export default function FormField({
 ...
 const labelStyles = labelClassName || "text-primary-text  block mb-1";

 // Base input classes
 const inputBaseClasses = `w-full border border-border px-4 py-2.5 text-primary bg-white focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-300 transition duration-150 disabled:bg-gray-50 disabled:  disabled:cursor-not-allowed`;
   ...
   <div className="relative">
    ...
    {isTextarea ? (
     <textarea
      ...
      rows={rows}
      className={`${inputBaseClasses} py-2.5   resize-none ${className}`}
      value={value}
      onChange={onChange}
      {...props}
     />
