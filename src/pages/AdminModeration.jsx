  ...
  <div className="max-w-6xl mx-auto space-y-10 py-6 text-primary">
   <header className="border-b border-border pb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div className="text-left">
     <h1 className="  text-primary">Admin — Review Papers</h1>
     <p className="mt-1    flex items-center gap-1.5">
      <Eye className="w-3.5 h-3.5  " /> Curate and manage submissions
     </p>
    </div>
    <div className="flex items-center gap-2.5">
     <span className=" bg-primary   border border-gray-950 px-3.5 py-1.5 ">
   ...
   {loadError && (
    <div className="border border-red-200 bg-red-50 p-4 text-red-800" role="alert">
     <p className="">Could not load Supabase submissions</p>
