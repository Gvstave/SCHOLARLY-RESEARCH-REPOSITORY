...
const SearchResults = () => {
  ...
  return (
    <div className="light min-h-screen bg-background">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-slate-50/80 backdrop-blur-md border-b border-slate-200/15 flex justify-between items-center px-8 py-4 max-w-full">
        <div className="flex items-center gap-8">
          <span className="text-xl font-bold tracking-tight text-slate-900 font-['Public_Sans']">
            The Curated Archive
          </span>
          <div className="hidden md:flex gap-6 items-center">
            <a className="text-blue-700 border-b-2 border-blue-700 pb-1 font-['Public_Sans'] text-sm font-medium" href="#">
              Search
            </a>
            <a className="text-slate-600 hover:bg-blue-50/50 transition-colors px-2 py-1 font-['Public_Sans'] text-sm font-medium" href="#">
              Journals
            </a>
            <a className="text-slate-600 hover:bg-blue-50/50 transition-colors px-2 py-1 font-['Public_Sans'] text-sm font-medium" href="#">
              Topics
        ...
        <div className="flex items-center gap-4">
          <div className="relative hidden sm:block">
            ...
            <input
              className="font-['Public_Sans'] text-sm bg-surface-container-low border-none focus:ring-1 focus:ring-primary w-64 pl-10 py-2"
              placeholder="Search archive..."
              type="text"
            />
          </div>
          <button className="font-['Public_Sans'] text-sm font-bold bg-primary text-on-primary px-6 py-2 transition-opacity active:opacity-80">
            Researcher Sign-in
          </button>
        </div>
      </nav>
